...
int main() {
	...
	int* h_hullPoints;
	int* h_numhullPoints;
	cudaHostAlloc((void**)&h_points, N*sizeof(Point), cudaHostAllocMapped);
	cudaHostAlloc((int**)&h_hullPoints, N*sizeof(int), cudaHostAllocMapped);
	cudaHostAlloc((int**)&h_numhullPoints, sizeof(int), cudaHostAllocMapped);
	...
	memset(h_numhullPoints, 0, sizeof(int));
	...
	int* d_hullPoints;
	int* d_numHullPoints;
	cudaHostGetDevicePointer((void**)&d_points, (void*)h_points, 0);
	cudaHostGetDevicePointer((int**)&d_hullPoints, (int*)h_hullPoints, 0);
	cudaHostGetDevicePointer((int**)&d_numHullPoints, (int*)h_numhullPoints, 0);
